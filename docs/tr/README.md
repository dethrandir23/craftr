...
Craftr'ın kalbi, YAML ile tanımlanan şablon sistemidir. Bir şablon, proje yapısını, klasörleri, dosyaları ve kullanıcıdan istenecek değişkenleri tanımlar. İşte dahili `cpp` şablonunun `template.yaml` dosyası:
